...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            cv2.imshow("demo", im0)
            cv2.imwrite("accident.jpg",im0)
            if len(det):
                if names[c]=="Accident_Detected":
                            bot.sendMessage('5446609180',str("Accident detected"))
                            bot.sendPhoto('5446609180',photo=open("accident.jpg","rb"))
